...
class Product extends Model
{
    ...
    public const string DEFAULT_IMAGE_PATH = '/images/product.jpeg';

    public const string DEFAULT_ALT_TEXT = 'Shape your perfect store';
    ...
    protected function getDefaultImageModel(): Image
    {
        return new Image([
            'path' => self::DEFAULT_IMAGE_PATH,
            'alt_text' => self::DEFAULT_ALT_TEXT . $this->heading,
            'is_featured' => true,
            'order' => 0,
            'is_default' => true,
        ]);
