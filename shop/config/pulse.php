...
return [
    ...
    */
    ...
    // No dashboard here. The storefront only *records* into the shared
    // pulse_* tables; the dashboard lives in the admin panel, behind the
    // super-admin gate. A `/pulse` route on a public storefront would be one
    // misconfigured gate away from exposing slow queries and stack traces to
    // customers, so the route is simply never registered.
    'path' => null,
